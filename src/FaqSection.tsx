...
const FAQ_ITEMS: FaqItem[] = [
  ...
  {
    id: 'metrics',
    question: 'Какие показатели здоровья мы определяем?',
    answer:
      'Мы анализируем более 20 физиологических показателей организма на основе сигналов вашего тела, полученных через камеру телефона.\n\nОсновные показатели, которые вы увидите в результате:\n • Частота пульса и дыхания\n • Артериальное давление (систолическое и диастолическое)\n • Индекс стресса Баевского\n • Биологический возраст сердца\n • Кардиальная нагрузка\n • Риск сердечно-сосудистых состояний\n\nПоказатели с числовыми значениями:\n • Гемоглобин\n • Гликированный гемоглобин (HbA1c)\n\nОценка рисков по ключевым параметрам:\n • Уровень холестерина\n • Глюкоза натощак\n • Риск низкого гемоглобина\n\nДополнительные расчётные метрики:\n • Среднее артериальная и пульсовое давление\n • Коэффициент пульс/дыхание (PRQ)\n\nИИ определяет и использует десятки дополнительных параметров (например, SDNN, RRI и другие), которые повышают точность расчётов.\n\nВы видите только понятные показатели — вся сложная аналитика работает "под капотом".',
  },
  {
