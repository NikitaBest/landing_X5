      ...
      <div className="section signals__inner">
        ...
        <div className="signals__content">
          <div className="signals__intro">
            ...
            Камера считывает микросигналы и отражение света от поверхности кожи лица, фиксирую колебания и свойства крови в сосудах - метод фотоплетизмографии (rPPG). Далее ИИ анализирует эти микросигналы и превращает их в данные о состоянии вашего здоровья.
            </p>
          </div>
          ...
          <div className="signals__list">
            <article className="signals__item">
              ...
              <div>
                ...
                <p>
                Метод фотоплетизмографии, применяемый в медицине и носимых устройствах, теперь работает через камеру смартфона
                </p>
              </div>
            </article>
